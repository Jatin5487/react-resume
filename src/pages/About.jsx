        ...
        <section className="section-1 h-screen px-12 flex justify-center items-center ">
          <div className="left w-[60%] px-6 text-xl flex flex-col gap-8">
            ...
            <h2 className="text-white">
              ...
              from Haryana, India. I am currently persuing{" "}
              <span className="text-purple-500 font-semibold">
                Full Stack Web Development
              </span>{" "}
              on <span className="text-green-400">Geekster.</span>I have
              completed{" "}
              <span className="text-purple-500 font-semibold">BCA (BCA)</span>{" "}
              from DAVCC
            </h2>
            ...
            <ul className="px-8">
              ...
              <li className="list-['🔍']">
                <span className="px-2"></span> Listening Music
              </li>
              <li className="list-['🔍']">
                <span className="px-2"></span> Trying New Cuisines
              </li>
            </ul>
          </div>
